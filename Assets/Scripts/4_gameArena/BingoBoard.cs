...
public class BingoBoard : MonoBehaviour, IPointerClickHandler
{
    ...
    public void isBingo()
    {
        ...
        bool h_1 = Problem.Instance.bingo_h1.TrueForAll(p => p == 00);
        bool h_2 = Problem.Instance.bingo_h2.TrueForAll(p => p == 00);
        bool h_3 = Problem.Instance.bingo_h3.TrueForAll(p => p == 00);
        bool h_4 = Problem.Instance.bingo_h4.TrueForAll(p => p == 00);
        bool h_5 = Problem.Instance.bingo_h5.TrueForAll(p => p == 00);
        bool v_1 = Problem.Instance.bingo_v1.TrueForAll(p => p == 00);
        bool v_2 = Problem.Instance.bingo_v2.TrueForAll(p => p == 00);
        bool v_3 = Problem.Instance.bingo_v3.TrueForAll(p => p == 00);
        bool v_4 = Problem.Instance.bingo_v4.TrueForAll(p => p == 00);
        bool v_5 = Problem.Instance.bingo_v5.TrueForAll(p => p == 00);
        bool d_1 = Problem.Instance.bingo_d1.TrueForAll(p => p == 00);
        bool d_2 = Problem.Instance.bingo_d2.TrueForAll(p => p == 00);
